...
# Example Usage
input_folder = '/workspaces/Arecanut-quality-classification/image-preprocessing/preprocessed/preprocessed-kole'  # Replace with the path to your input folder
output_folder = '/workspaces/Arecanut-quality-classification/labels/kole-labelled'  # Replace with the path to your output folder
label = 'III'  # Label to be added to all images
