...
# Example Usage
input_folder = '/workspaces/Arecanut-quality-classification/image-preprocessing/preprocessed/preprocessed-gpre'  # Replace with the path to your input folder
output_folder = '/workspaces/Arecanut-quality-classification/labels/gotu-labelled'  # Replace with the path to your output folder
label = 'II'  # Label to be added to all images
